...
#include "Random.glsl"
#include "RayTracingCommons.glsl"
...
// Dielectric
RayPayload ScatterDielectric(const Material m, const vec3 direction, const vec3 normal, const vec2 texCoord, const float t, inout uint seed)
{
...
RayPayload Scatter(const Material m, const vec3 direction, const vec3 normal, const vec2 texCoord, const float t, inout uint seed)
{
	...
	case MaterialDielectric:
		return ScatterDielectric(m, normDirection, normal, texCoord, t, seed);
